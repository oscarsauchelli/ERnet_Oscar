...
# Use test to prepare the images for evaluation
# Takes 4 corners of size = ImageSize from the input image, evaluates them, and stitches them together, removing any overlap
